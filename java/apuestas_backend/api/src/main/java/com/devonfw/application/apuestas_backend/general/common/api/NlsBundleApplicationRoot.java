package com.devonfw.application.apuestas_backend.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.devonfw.application.apuestas_backend.general.common.api.exception.NoActiveUserException
   *
