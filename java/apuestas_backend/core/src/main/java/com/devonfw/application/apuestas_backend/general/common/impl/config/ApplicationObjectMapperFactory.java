package com.devonfw.application.apuestas_backend.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the apuestas_backend application.
 */
